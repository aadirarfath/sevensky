...
export function FAQSection() {
    ...
    return (
        <section id="faq" className="py-24 md:py-36 border-t border-white/10 bg-[#2d6fbc]">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 md:gap-24">
                    ...
                    <div className="lg:col-span-5">
                        ...
                        <div
                            ...
                            className="group cursor-pointer p-8 rounded-3xl bg-white/5 border border-white/10 transition-all duration-300 hover:border-white/30 hover:bg-white/10 hover:-translate-y-1"
                        >
                            <p
                            ...
                            <span className="inline-flex items-center gap-2 text-sm uppercase tracking-widest font-bold text-white border-b-2 border-white pb-1 group-hover:gap-4 transition-all">
                    ...
                    <div className="lg:col-span-7 divide-y divide-white/10">
                        {faqs.map((faq, index) => (
                            <div key={index} className="py-6 md:py-8">
                                ...
                                >
                                    <span className="text-xl md:text-2xl font-medium text-white transition-colors group-hover:text-white/60">
                                        {faq.question}
                                    </span>
                                    {openIndex === index ? (
                                        <Minus className="w-5 h-5 text-white shrink-0 ml-4" />
                                    ) : (
                                        <Plus className="w-5 h-5 text-white/30 shrink-0 ml-4" />
                                    )}
                                </button>
