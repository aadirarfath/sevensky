                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-12 md:gap-16">
                    ...
                    <div className="md:col-span-3">
                        ...
                        <div className="mt-12 grid grid-cols-2 gap-4">
                            <div className="border border-[#1E293B] bg-[#0F172A] rounded-xl p-6 hover:border-white/20 transition-colors duration-300">
                                <p
                                ...
                                <p className="text-sm text-white/40 mt-1">Projects Delivered</p>
                            </div>
                            <div className="border border-[#1E293B] bg-[#0F172A] rounded-xl p-6 hover:border-white/20 transition-colors duration-300">
                                <p
                                    className="text-5xl md:text-6xl text-white"
                                ...
                                <p className="text-sm text-white/40 mt-1">Average Client Rating</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="md:col-span-2 flex flex-col justify-center gap-6">
                        {principles.map(({ icon: Icon, title, description }) => (
                            <div
                                key={title}
                                className="flex items-start gap-5 p-6 border border-[#1E293B] bg-[#0F172A] rounded-xl hover:border-white/20 transition-colors duration-200 group"
                            >
                                <div className="shrink-0 w-10 h-10 rounded-full border border-[#1E293B] group-hover:border-white/20 flex items-center justify-center transition-colors duration-200">
