    ...
    return (
        ...
        >
            <div className="max-w-2xl mx-auto px-6 md:px-0">
                {/* Heading */}
                <h2
                    className="text-[16vw] sm:text-[10vw] md:text-[88px] leading-none text-[#1a4473] mb-4"
                    style={{ fontFamily: "var(--font-display)" }}
                >
                    LET&apos;S TALK
                </h2>
                <p className="text-[#1a4473]/60 mb-10">Tell us about your project.</p>
                ...
                {/* Footer contact info */}
                <div className="mt-12 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-8 border-t border-[#1a4473]/10">
                    <a
